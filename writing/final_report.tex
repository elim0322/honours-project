\documentclass[a4paper, 12pt]{report}
    ...
    \usepackage{url}
    \usepackage{tikz}
      \usetikzlibrary{decorations.text}  % decoration for for curved text
    \usepackage{hyperref}
